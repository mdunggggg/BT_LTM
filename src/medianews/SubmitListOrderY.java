...
/**
 * <p>Java class for submitListOrderY complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="submitListOrderY">
 *   &lt;complexContent>
 ...
 *         &lt;element name="object" type="{http://medianews.vn/}orderY" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "submitListOrderY", propOrder = {
    "studentCode",
    "qCode",
    "object"
})
public class SubmitListOrderY {

    protected String studentCode;
    protected String qCode;
    protected List<OrderY> object;
     ...
     * 
     */
    public List<OrderY> getObject() {
        if (object == null) {
            object = new ArrayList<OrderY>();
        }
        return this.object;
    }
