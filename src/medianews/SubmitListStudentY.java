...
/**
 * <p>Java class for submitListStudentY complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="submitListStudentY">
 *   &lt;complexContent>
 ...
 *         &lt;element name="object" type="{http://medianews.vn/}studentY" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "submitListStudentY", propOrder = {
    "studentCode",
    "qCode",
    "object"
})
public class SubmitListStudentY {

    protected String studentCode;
    protected String qCode;
    protected List<StudentY> object;
     ...
     * 
     */
    public List<StudentY> getObject() {
        if (object == null) {
            object = new ArrayList<StudentY>();
        }
        return this.object;
    }
